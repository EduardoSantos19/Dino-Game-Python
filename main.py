...
class GameState:
    ...
    def successors(self):
        # Defina a lógica para gerar os sucessores do estado
        pass

    def goal_test(self):
        # Defina a lógica para verificar se atingiu o objetivo
        pass

    def cost(self, next_state):
        # Defina a lógica para calcular o custo de transição para o próximo estado
        pass


def heuristic(state):
    # Heurística: estimativa da distância até o obstáculo mais próximo
    min_distance = SCREEN_WIDTH
    for obstacle in state.obstacles:
        distance = obstacle.rect.x - state.dino_pos
